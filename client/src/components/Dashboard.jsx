...
const Drawer = styled(MuiDrawer, {
  ...
  "& .MuiDrawer-paper": {
    ...
    backgroundColor: theme.palette.background.paper, // Set background color here
    ...(open && {
    ...
    <ThemeProvider theme={blackPurpleTheme}>
      <Box sx={{ display: "flex" }}>
        ...
        <Drawer
          ...
          sx={{
            "& .MuiDrawer-paper": {
              backgroundColor: theme.palette.background.paper, // Directly applying background color
            },
          }}
        >
          <Toolbar>
